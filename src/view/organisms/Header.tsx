      ...
      <CssBaseline />
        <AppBar position="static" style={{ background: '#d1c4e9', zIndex: 100 }}>
          <Toolbar>
            ...
            <a href="https://github.com/Shinnosuke7031"style={{color: "#6a1b9a"}}>
              <GitHubIcon style={{color: purple[800]}} />
            </a>
            <a href="https://twitter.com/web7031boushi" className={classes.twitter} style={{color: "#6a1b9a"}}>
              <TwitterIcon style={{color: purple[800]}} />
            </a>
